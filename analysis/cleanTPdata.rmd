...
DArTClones <- read.table(here::here("data","AllChrom_RefPanelAndGSprogeny_ReadyForGP_2022Aug03.fam"), 
...
germNamesWithDArT <- read.table(here::here("data","IITADArTClones.csv"), 
  ...
  mutate(germplasmName = ifelse(is.na(germplasmName.y),
                                yes = germplasmName.x,
                                no = germplasmName.y), .keep = "unused") %>% 
...
germNamesWithDArT <- read.table(file = here::here("data","IITADArTClones2.csv"),
                                sep = ",", header = T)
germNamesWithDArT$FullSampleName[germNamesWithDArT$FullSampleName %in% dbdata$FullSampleName]
